...
def generate_tpc(default_config: OpQuantizationConfig,
    ...
    default_config_options_8bit = schema.QuantizationConfigOptions(
    ...
    # Sigmoid output is 8bit.
    sigmoid = schema.OperatorsSet(name=schema.OperatorSetNames.SIGMOID, qc_options=default_config_options_8bit)
    ...
    operator_set.extend(
        [conv, conv_transpose, depthwise_conv, fc, relu, relu6, leaky_relu, add, sub, mul, div, prelu, swish, hardswish,
         sigmoid, tanh, gelu, hardsigmoid, hard_tanh, exp, sin, cos])
